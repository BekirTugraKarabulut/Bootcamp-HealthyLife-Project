...
class Obez extends StatefulWidget {
  ...
  Obez({required this.ad,required this.yas,required this.boy,required this.kilo,required this.cinsiyet,required this.vucutIndeks});

  @override
  State<Obez> createState() => _ObezState();
}

class _ObezState extends State<Obez> {
  @override
      ...
      body: Column(
        children: [
              ...
              children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Text("Obez İndeks(1.derece)", style: TextStyle(fontWeight: FontWeight.bold),),
          ...
          Padding(
            ...
            child: Column(
              children: [
                Image.asset("resimler/obez.png")
              ],
            ),
          ),
          Text("Obez (1.derece)" , style: TextStyle(fontWeight: FontWeight.bold , color: Colors.red , fontSize: 20),),
          Column(
            children: [
              Padding(
